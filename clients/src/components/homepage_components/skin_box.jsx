...
const SkinBox = ({name , color, skinUrl, avatarColor, buySkin}) => {
  ...
  return (
        <div style={boxStyle}>
            ...
            <button onClick={buySkin} style = {buyButtonStyle} onMouseEnter = {() => setBuyButtonHover(true)} onMouseLeave = {() => setBuyButtonHover(false)}>
                Buy
            </button>
        </div>
  );
